          ...
          {props.category.map((movie) => (
            ...
            >
              <div className="image h-[100%] w-full relative group ">
                <div onClick={() => {SeeViewsClick(movie)}} className="box absolute top-0 left-0 right-0 bottom-0 cursor-pointer group-hover:bg-[rgba(0,0,0,0.4)] duration-100 ease-in-out"></div>
                <img
